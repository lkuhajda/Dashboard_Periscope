...
, final_table as
(
	 select [BudgetMonth], month_name, [BudgetYear], 'Budget' as name,  Amount 
...
select 'YTD Budget' as type, (select cumulativesum from final_table where BudgetMonth = @ReportMonth and name = 'Budget') as value
union
select 'YTD Actual Burn', (select cumulativesum from final_table where BudgetMonth = @ReportMonth and name = 'Actual Burn')
union
select 'YTD Under/(Over) Burn', (select cumulativesum from final_table where BudgetMonth = @ReportMonth and name = 'Actual Burn') - (select cumulativesum from final_table where BudgetMonth = @ReportMonth and name = 'Budget')
